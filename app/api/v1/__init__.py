...
from app.api.v1.endpoints import ingest_faststream, subscriptions, stats, topics

api_router = APIRouter()

# Include all endpoint routers - 使用 FastStream 版本的 ingest
api_router.include_router(ingest_faststream.router, prefix="/ingest", tags=["webhook-ingestion"])
